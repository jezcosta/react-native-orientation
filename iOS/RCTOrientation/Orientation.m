...
RCT_EXPORT_METHOD(unlockAllOrientations)
{
  ...
  [Orientation setOrientation:UIInterfaceOrientationMaskAll];
    [self lockToOrientationWithMask:UIInterfaceOrientationMaskAll interfaceOrientation:UIInterfaceOrientationMaskAll deviceOrientation:UIInterfaceOrientationMaskAll];
